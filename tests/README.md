...
- `ManifestLiquidGlassVisualCheck.tscn` opens the generated `ui.liquid_glass`
  package and verifies resource-backed styles, generated scripted-control
  events and inputs, layout bounds, and nonblank rendering at three sizes.
...
Run the Manifest/Liquid Glass integration visual gate separately with:

```powershell
./tests/Run-ManifestLiquidGlassVisual.ps1 -GodotBin $env:GODOT_BIN
```
